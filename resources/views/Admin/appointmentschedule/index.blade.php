...
@section('content')
    <div class="card w-100">
        <div class="card-body p-4">
            <h5 class="card-title fw-semibold mb-4">Quản lý khám bệnh</h5>
            <div class="table-responsive">
                <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tr>
                        ...
                        <td class="border-bottom-0">
                            <p class="mb-0 fw-semibold">Nguyen Van Admin</p>
                        </td>
                        <td class="border-bottom-0">
                            <span class="fw-semibold mb-0">+84 87654576</span>
                        </td>
                        <td class="border-bottom-0">
                            <span class="fw-semibold mb-0">Thăm khám</span>
                        </td>
