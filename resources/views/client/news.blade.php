                                            ...
                                            <div class="item">
                                                <div class="item__frame">
                                                    <div class="item__thumb">
                                                        <a href="{{ route('client.detailnews', ['slug' => $item->slug]) }}" class="item__thumb--link">
                                                    ...
                                                    <div class="item__body">
                                                        <h2 class="item__title">
                                                            <a href="{{ route('client.detailnews', ['slug' => $item->slug]) }}" class="item__link title">{{ $item->title }}</a>
                                                        </h2>
                                                        <div class="item__body--wrap">
                                                            <a href="{{ route('client.news') }}" class="item__category">Tin tức</a>
                                                            <div class="sep"></div>
                                                    ...
                                                    <div class="col-4 l-4 mc-6 c-12">
                                                        <div class="item" style="padding: 0px 8px 0px 8px">
                                                            <div class="item__frame">
                                                                <div class="item__thumb">
                                                                    <a href="{{ route('client.detailnews', ['slug' => $blog->slug]) }}" class="item__thumb--link">
                                                                        @if(!empty($blog->thumbnail))
                                                                            <img src="data:image/jpeg;base64,{{ $blog->thumbnail }}" alt="{{ $blog->title }}" />
                                                                        @else
                                                                            <img src="path/to/default/image.jpg" alt="Default Image" />
                                                                        @endif
                                                                    </a>
                                                                ...
                                                                <div class="item__body">
                                                                    <h2 class="item__title">
                                                                        <a href="{{ route('client.detailnews', ['slug' => $blog->slug]) }}" class="item__link title">{{ $blog->title }}</a>
                                                                    </h2>
                                                                    <div class="item__body--wrap">
                                                                        <a href="{{ route('client.news') }}" class="item__category">Tin tức</a>
                                                                        <div class="sep"></div>
                                                                        <div class="item__published">{{ $blog->date }}</div>
                                                                    </div>
                                                                    <div class="item__description">
                                                                        {{ $blog->describe }}
                                                                    </div>
                                                ...
                                                <div class="box-btn-view-more">
                                                    <div class="col l-12 mc-12 c-12 text-center">
                                                        <form action="{{ route('client.news') }}" method="get">
                                                            ...
                                                            <button type="submit" class="btn btn-view-more">Xem thêm</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            @endif
