            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="specialty-form">
                        ...
                        <div class="mb-3">
                            <input class="form-check-input" type="checkbox" value="" name="status" id="specialtyStatus">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="specialty-form">
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Tên chuyên khoa:</label>
                            <input type="text" name="nameEdit" class="form-control" id="specialtyNameEdit" value="">
