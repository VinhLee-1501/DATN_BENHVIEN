                        ...
                        <div class="card w-100">
                            ...
                            <div class="card-body px-3">
                                ...
                                <form action="{{ route('system.checkupHealth.saveService', $book->book_id) }}"
                                    method="post">
                                    @csrf
                                    <table class="table m-0" id="selectedTestsTable">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                        ...
                                        <tbody>
                                            <input type="hidden" id="selectService" name="selectedService"
                                                value="">
                            ...
                            <div class="card-body px-3 ">
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-md-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input placeholder="Cân nặng" type="text" class="form-control" id="weight"
                                                name="weight" value="{{ old('weight') }}" style="max-width: 120px;">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center mt-2 mt-md-0">
                                                <button type="button" class="btn btn-success me-2 mb-2 mb-md-0"
                                                    onclick="Chose()">Lưu</button>
