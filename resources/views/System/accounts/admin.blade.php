<div class="card w-100">
    <div class="card-body p-4">
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <tr>
    <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{ $item->user_id }}</h6></td>
    <td class="border-bottom-0"><p class="mb-0 fw-semibold">{{ $item->lastname }} {{ $item->firstname }}</p></td>
    ...
    <td class="border-bottom-0 d-flex">
        ...
        <form action="{{ route('system.accounts.destroy', $item->user_id) }}" id="form-delete{{ $item->user_id }}" method="post">
            @method('delete')
            @csrf
        </form>
