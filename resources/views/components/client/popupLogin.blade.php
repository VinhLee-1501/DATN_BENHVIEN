                            ...
                            <div class="form__social-login text-center">
                                <a href="{{ route('client.auth.google') }}">
                                    <div style="background-color: #ea4335; color: #fff"
                                        ...
                                        <span>Đăng nhập với</span><Span style="font-size: 25px;"><i
                                                class="fa-brands fa-google"></i> </Span>

                                    </div>
                                </a>
                                <a href="{{ route('client.auth.facebook') }}">
                                    <div style="background-color: #0068FF; color: #fff"
                                        class="button btn-facebook-login btn-flex">
                                        <span>Đăng nhập với</span><Span style="font-size: 25px;"><i
                                                class="fa-brands fa-facebook"></i></Span>

                                    </div>
                                </a>
                                <a href="{{ route('client.auth.zalo') }}">
                                    <div style="background-color:#0068FF; color:#fff"
                                        class="button btn-zalo-login btn-flex">
                                        <span>Đăng nhập với</span><span style="font-size: 25px;">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32"
                                                height="32" viewBox="0 0 50 50" fill="white">
                                                <path
