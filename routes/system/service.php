...
Route::prefix('services')->middleware('check_login_admin')
    ->group(function () {
        ...
        Route::get('/inactive', [ServiceController::class, 'indexInactive'])->name('services.inactive');
        ...
        Route::delete('/multipledelete', [ServiceController::class, 'index'])->name('services.multipledelete');
