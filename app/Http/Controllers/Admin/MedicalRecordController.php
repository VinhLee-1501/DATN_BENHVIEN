...
class MedicalRecordController extends Controller
{
    ...
    public function detail($id)
    {
        $medical = MedicalRecord::join('patients', 'patients.patient_id', '=', 'medical_records.patient_id')
            ...
            'patients.birthday', 'users.phone', 'treatment_details.treatment_id')
    ...
    {
        $treatment = TreatmentDetail::join('medical_records', 'medical_records.medical_id', '=',
            'treatment_details.medical_id')
            ->join('patients', 'patients.patient_id', '=', 'medical_records.patient_id')
            ->join('treatment_medications', 'treatment_medications.treatment_id', '=',
            ...
            ->select('medical_records.*', 'treatment_details.*', 'medicines.name', 'patients.first_name',
                'patients.last_name', 'patients.birthday', 'patients.gender', 'treatment_medications.quantity',
