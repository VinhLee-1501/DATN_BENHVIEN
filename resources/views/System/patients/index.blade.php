                                    ...
                                    <div class="col-md-12 row mb-3">
                                        <div class="col-2 profile-img col-md-2 d-flex align-items-center">
                                            ...
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png"
                                                alt="Ảnh bác sĩ" class="img-thumbnail" style="width: 80%; height: auto;">
                                            @else
                                            <img src="{{ asset('storage/uploads/avatars/' . $item->avatar) }}" alt="Ảnh bác sĩ" class="img-thumbnail" style="width: 80%; height: auto;">
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-5 col-md-5 mb-3">
                                            ...
                                            <table class="table table-bordered mt-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="text-center">
                                                        <td class="py-1"><strong>{{ $record->medical_id }}</strong></td>
                                                        <td class="py-1">
                                                            <a href="{{ route('system.detail_medical_record', $record->medical_id) }}">
                                                                {{ $record->diaginsis }}
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    @else
                                                    <tr class="text-center">
                                                        <td class="py-1" colspan="2">Không có hồ sơ y tế.</td>
                                                    </tr>
                                                    @endif
                                                </tbody>
                                            </table>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.specialty.forEach(function(item) {
                    specialtySelect.append('<option value="' + item.specialty_id + '">' + item.name + '</option>');
                });
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                response.schedule.forEach(function(item) {
                                    shiftSelect.append('<option value="' + item.shift_id + '">' + 'Bs.' + item.lastname + ' ' + item.firstname + '</option>');
                                });
