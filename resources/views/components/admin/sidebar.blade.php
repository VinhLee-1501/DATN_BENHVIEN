            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar " data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li
                            class="sidebar-item {{ request()->is('system/order*') || request()->is('system/order?*') ? 'selected' : '' }}">
                        ...
                        <li
                            ...
                            <a class="sidebar-link" href="{{ route('system.order') }}" aria-expanded="false">
                                ...
                                <span class="hide-menu">Quản lý hóa đơn dịch vụ</span>
                            </a>
                        </li>
                        <li
                            class="sidebar-item {{ request()->is('system/orderproduct*') || request()->is('system/orderproduct?*') ? 'selected' : '' }}">
                            <a class="sidebar-link" href="{{ route('system.orderproduct') }}" aria-expanded="false">
                                <span>
                                    <i class="ti ti-receipt-2"></i>
                                </span>
                                <span class="hide-menu">Quản lý hóa đơn mua hàng</span>
                            </a>
                        </li>
                        <li
                            ...
                            <a class="sidebar-link" href="{{ route('system.serviceType') }}" aria-expanded="false">
                                ...
                                <span class="hide-menu">Quản lý danh mục dịch vụ</span>
                            </a>
                        </li>
                    </ul>
                    </li>
